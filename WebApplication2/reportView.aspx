...
<rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="80%" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="WebApplication2.FleetDBDataSet1TableAdapters.CompanyInfoTableAdapter">
        <InsertParameters>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="WebApplication2.FleetDBDataSet1TableAdapters.VehiclesTableAdapter" UpdateMethod="Update">
        <DeleteParameters>
